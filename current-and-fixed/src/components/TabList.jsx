...
export const TabList = ({ tabs, onTabChange }) => {
  ...
  const defaultSelectedTabStyles = [
    ' [&:nth-child(1)]:bg-neutral-950',
    ' [&:nth-child(2)]:bg-neutral-950',
    ' [&:nth-child(3)]:bg-neutral-950',
    ' [&:nth-child(4)]:bg-neutral-950'
  ]
  ...
  return (
    <div
      className={
        'w-fit relative border  border-neutral-400 rounded-full flex gap-5 items-center justify-center p-2 backdrop-blur-2xl'
      }
    >
      {tabs.map((link, i) => (
        <button
          ...
          className={twMerge(
            'transition-colors duration-200 flex items-center text-white justify-center rounded-full h-fit px-2 py-2 text-nowrap',
        ...
        <div className={'relative h-full w-full overflow-hidden'}>
          <div
            ...
            className={twMerge(
              ...
              fired.current ? 'bg-sky-300/30' : 'bg-transparent'
            )}
          />
        </div>
      </div>
