      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-sky-300/10"
            />
          )}
...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return isOpen ? (
    ...
    <IconMenu2 className=" z-50 text-white" onClick={onClick} />
  );
};
  ...
  return (
    ...
    >
      {/* <Image
        ...
        height={30}
      /> */}
      <span className="font-bold  font-sans text-white">ASM Saki</span>
    </Link>
  );
};
