      ...
      <div id="services" className="max-w-5xl mx-auto px-10 ">
        ...
        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <GridItem
            ...
            idx={1}
            icon={
              <IconDeviceDesktopCode className="h-4 w-4 text-neutral-400" />
            }
          ...
          <GridItem
            number="02"
            idx={2}
            icon={<IconDeviceMobileCode className="h-4 w-4 text-neutral-400" />}
          ...
          <GridItem
            number="03"
            idx={3}
            icon={<IconLayoutDashboard className="h-4 w-4  text-neutral-400" />}
          ...
          <GridItem
            ...
            icon={
              ...
              <IconLayoutCollage className="h-4 w-4 text-neutral-400" />
            }
          ...
          <GridItem
            ...
            icon={
              ...
              <IconServer className="h-4 w-4 text-neutral-400" />
            }
  ...
  return (
    ...
    >
      <div className="relative h-full rounded-2xl p-2 md:rounded-3xl md:p-3">
        ...
        <motion.div className="border-0.75 bg-gradient-to-br #201b16 from-[#201b15] to-[#170d16] relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-6 shadow-[0px_0px_27px_0px_#2D2D2D]">
          <motion.div
