  ...
  return (
    <div className="lg:h-screen bg-gradient-to-br from-purple-950/20 via-sky-950/30 to-gray-900/50 py-12 flex items-center justify-center">
      ...
      >
        {/* Image section */}
        <motion.div 
          className="relative w-3/4 md:w-1/3 h-auto md:h-auto"
        ...
        <div className="w-full md:w-2/3">
          ...
          >
            ...
            >
              ...
              Skilled in React, Express.js, Firebase, and MongoDB, I'm eager to
          ...
          >
            ...
            <motion.a 
              href="https://github.com/Saki4555" 
              target="_blank"
              variants={socialIconVariants}
              whileHover="hover"
            >
            ...
            <motion.a 
              href="https://www.facebook.com/asm.saki.18" 
              target="_blank" 
              variants={socialIconVariants}
              whileHover="hover"
            >
          ...
          >
            <motion.a 
              ...
              className="px-8 py-2 transform cursor-pointer rounded-lg font-medium text-slate-100 transition-all duration-300 bg-[#7f5af0]/50 hover:bg-[#9273f7]/70 shadow-[0_0_10px_rgba(127,90,240,0.4)]"
              whileHover={{ 
                y: -5,
