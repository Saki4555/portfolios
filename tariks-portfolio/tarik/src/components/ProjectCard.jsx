        ...
        <div className="md:w-2/3 p-8 flex flex-col">
          ...
          >
            <motion.a
              href={github}
              target="_blank"
              className="transform hidden text-center rounded-lg border border-[#7f5af0]/50 px-8 py-2 font-medium text-sm transition-all duration-300 hover:-translate-y-0.5 text-[#7f5af0] bg-[#16161a] hover:bg-[#0e0e10] shadow-[0_0_10px_rgba(127,90,240,0.4)]"
            >
              Github
            </motion.a>
            <motion.a
